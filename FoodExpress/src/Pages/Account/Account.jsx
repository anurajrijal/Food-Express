          ...
          <div className="relative right-0">
            <ul className="relative flex flex-wrap px-1.5 py-1.5 list-none rounded-md bg-slate-100" data-tabs="tabs" role="list">
              <li className="z-30 flex-auto text-center">
                <a
                  className={`z-30 flex items-center justify-center w-full px-0 py-2 text-sm mb-0 transition-all ease-in-out border-0 rounded-md cursor-pointer text-slate-600 bg-inherit ${activeTab === "signIn" ? `${styles.underline} active` : ""}`}
              ...
              <li className="z-30 flex-auto text-center">
                <a
                  className={`z-30 flex items-center justify-center w-full px-0 py-2 mb-0 text-sm transition-all ease-in-out border-0 rounded-lg cursor-pointer text-slate-600 bg-inherit ${activeTab === "signUp" ? `${styles.underline} active` : ""}`}
            ...
            {/* Sign In Form */}
            <div data-tab-content="" className={`p-5 ${styles.tabContent} ${activeTab === "signIn" ? styles.active : ""}`}>
              <div id="signIn" role="tabpanel" className={activeTab === "signIn" ? "" : "hidden opacity-0"}>
                <div className={styles.formContainer}>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <label className={styles.forgotPassword}>Forgot Password? Click here</label>
            ...
            {/* Sign Up Form */}
            <div data-tab-content="" className={`p-5 ${styles.tabContent} ${activeTab === "signUp" ? styles.active : ""}`}>
              <div id="signUp" role="tabpanel" className={activeTab === "signUp" ? "" : "hidden opacity-0"}>
                <div className={styles.formContainer}>
                  <button className={styles.loginGoogle}>Sign Up with Google</button>
